...
export const skills = [
  ...
  { name: "State Management", stack: "Frontend", icon: "redux" },
  { name: "Cache", stack: "Frontend", icon: "cache" },
  { name: "Browser Storage", stack: "Frontend", icon: "storage" },
  { name: "Node.js", stack: "Backend", icon: "nodejs" },
  { name: "Express.js", stack: "Backend", icon: "express" },
  { name: "Python", stack: "Backend", icon: "python" },
  { name: "FastAPI", stack: "Backend", icon: "fastapi" },
  { name: "REST APIs", stack: "Backend", icon: "api" },
  { name: "Authentication", stack: "Backend", icon: "auth" },
  { name: "Redis", stack: "Backend", icon: "redis" },
  { name: "Microservices", stack: "Backend", icon: "microservices" },
  { name: "Caching", stack: "Backend", icon: "cache" },
  { name: "LLM Integration", stack: "Backend", icon: "llm" },
  ...
  { name: "Vector Database", stack: "Database", icon: "vectordb" },
  { name: "Schema Design", stack: "Database", icon: "schema" },
  { name: "Indexing & Query Optimization", stack: "Database", icon: "indexing" },
  { name: "Sequelize", stack: "Database", icon: "sequelize" },
  { name: "Git", stack: "DevOps", icon: "git" },
  { name: "GitHub", stack: "DevOps", icon: "github" },
  { name: "CI/CD Pipeline", stack: "DevOps", icon: "cicd" },
  { name: "AWS", stack: "DevOps", icon: "aws" },
  { name: "Vercel / Railway / Render", stack: "DevOps", icon: "vercel" },
  { name: "Nginx", stack: "DevOps", icon: "nginx" },
  { name: "PM2", stack: "DevOps", icon: "pm2" },
  { name: "Environment & Secrets", stack: "DevOps", icon: "secrets" },
  { name: "Hostinger", stack: "DevOps", icon: "hosting" },
  { name: "Scikit-learn", stack: "ML/AI", icon: "scikit" },
  { name: "RAG", stack: "ML/AI", icon: "rag" },
  { name: "LLM APIs", stack: "ML/AI", icon: "llm" },
  { name: "Embeddings", stack: "ML/AI", icon: "embeddings" },
  { name: "Prompt Engineering", stack: "ML/AI", icon: "prompt" },
];
...
export const experience = [
  {
    ...
    logo: "/Portfolio/assets/images/ots.jpg",
    location: "Onsite",
    description:
  ...
  },
  {
    ...
    logo: "/Portfolio/assets/images/gdsc.png",
    location: "Remote",
    description:
  ...
  },
  {
    ...
    position: "Front-End Developer",
    company: "NextGenDev",
    logo: "/Portfolio/assets/images/nextgen.jpg",
    location: "Remote",
    description:
  ...
  },
  {
    ...
    logo: "/Portfolio/assets/images/placement.jpg",
    location: "Remote",
    description:
...
export const projects = [
  {
    id: 1,
    title: "TheraKonnect (FYP)",
    image: "/Portfolio/assets/images/thera.png",
    link: "https://dev2.therakonnect.com/",
    technologies: ["MERN Stack", "ChatBot"],
  },
  {
    id: 2,
    title: "EdTech",
  ...
  },
  {
    id: 4,
    title: "AgilePilot",
    image: "/Portfolio/assets/images/agile.png",
    link: "https://github.com/zaakiraza/AGILEPILOT-Backend",
    technologies: ["MERN Stack"],
  },
  {
    id: 5,
    title: "Chatbot",
    image: "/Portfolio/assets/images/bot.png",
    link: "https://github.com/zaakiraza/FYP-CHATBOT",
    technologies: ["Python", "FastAPI", "RAG", "LLM", "Redis"],
  },
  {
    id: 6,
  ...
  },
  {
    id: 9,
    title: "Fitness Pro",
    image: "/Portfolio/assets/images/fitness.png",
    link: "https://zaakiraza.github.io/fitness/",
    technologies: ["HTML", "CSS", "JavaScript"],
  },
  {
    id: 10,
    title: "Small School Management",
    image: "/Portfolio/assets/images/sml.png",
    link: "https://github.com/zaakiraza/Small_Sch_Management",
    technologies: ["React"],
  },
  {
    id: 11,
...
export const competitions = [
  {
    id: 6,
    title: "KSBL Hackathon",
    year: "2026",
    role: "Full Stack Developer",
    description:
      "Built a full-stack application using MERN stack with a Python FastAPI backend, integrating LLM and RAG for intelligent features.",
    link: "https://ksbl-frontend.vercel.app/login",
  },
  {
    id: 7,
    title: "SHU Hackathon",
    ...
    role: "Full Stack Developer",
    description:
      "Developed a campus connect application using the MERN stack during the hackathon.",
    link: "https://shu-frontend.vercel.app/",
  },
  {
    id: 1,
